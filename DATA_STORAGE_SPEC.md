...
|---|---|---|---|
| Config | `${XDG_CONFIG_HOME:-~/.config}/soia-skills/soia-open-dev-design-skills/...` | same unless the host integration deliberately uses the native app-support directory | `%APPDATA%\soia-skills\soia-open-dev-design-skills\...` |
| State | `${XDG_STATE_HOME:-~/.local/state}/soia-skills/soia-open-dev-design-skills/...` | same | `%LOCALAPPDATA%\soia-skills\soia-open-dev-design-skills\state\...` |
| Cache | `${XDG_CACHE_HOME:-~/.cache}/soia-skills/soia-open-dev-design-skills/...` | `~/Library/Caches/soia-skills/soia-open-dev-design-skills/...` | `%LOCALAPPDATA%\soia-skills\soia-open-dev-design-skills\Cache\...` |
