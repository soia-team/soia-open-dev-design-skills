...
def resolve_repo_name(root: Path) -> str:
    ...
    # https://github.com/soia-team/soia-open-dev-design-skills.git  -> soia-open-dev-design-skills
    # git@github.com:soia-team/soia-open-dev-design-skills.git       -> soia-open-dev-design-skills
    tail = url.rstrip("/")
    for sep in ("/", ":"):
        if sep in tail:
