...
`soia-open-dev-design-skills` and `soia-private-skills` intentionally use the same template
...
- `hard` / `optional` list SOIA-managed skill names only (published from
  soia-open-dev-design-skills or soia-private-skills).
...
~/.config/soia-skills/soia-open-dev-design-skills/soia-pkm/soia-pkm-transform/config.yml
```
...
`~/.config/soia-skills/soia-open-dev-design-skills/soia-pkm/soia-pkm-transform/notebooklm`.
...
format and is intentionally absent from `soia-open-dev-design-skills`.
